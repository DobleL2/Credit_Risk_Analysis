import unittest
import Credit_Risk_Analysis.model.ml_serviceL as ml_serviceL
import pandas as pd

class TestMLService(unittest.TestCase):
    def test_predict(self):
        ml_serviceL.settings.UPLOAD_FOLDER = "tests/"        
        ...
        class_name, pred_probability = ml_serviceL.predict(df)        
